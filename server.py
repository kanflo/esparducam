...
Run this script on a host and try the 'upload:<host>' command on the Esparducam
...
Directory listing removed, GET returns 501
...
#            f.close()
    ...
    def deal_post_data(self):
        ...
        fn = os.path.join(path, "uploads/%s" % fn[0])
        line = self.rfile.readline()
        remainbytes -= len(line)
        line = self.rfile.readline()
        remainbytes -= len(line)
